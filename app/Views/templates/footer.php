        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>Una plataforma para compartir y descubrir proyectos creativos.</p>
                </div>
                <div class="col-md-4">
                    <h5>Enlaces Rápidos</h5>
                    <ul class="list-unstyled">
                        <li><a href="#" class="text-decoration-none">Inicio</a></li>
                        <li><a href="#" class="text-decoration-none">Explorar</a></li>
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    <small>&copy; 2024 Tu Plataforma. Todos los derechos reservados.</small>
                </div>
            </div>
        </div>
    </footer>
